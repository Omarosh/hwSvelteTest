var app = (function () {
    ...
    /* src\HT.svelte generated by Svelte v3.24.0 */
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="./handwashing.gif" alt="How to wash hands" class="svelte-1wsp3u5">`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-awyszr");
    			set_style(div0, "width", /*width*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-awyszr");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    class Progressbar extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance, create_fragment$1, safe_not_equal, { width: 0 });
    	}
    }

    /* src\timer.svelte generated by Svelte v3.24.0 */
    ...
    function create_fragment$2(ctx) {
    	...
    	let mounted;
    	let dispose;
    	progressbar = new Progressbar({ props: { width: /*progress*/ ctx[2] } });
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*progress*/ 4) progressbar_changes.width = /*progress*/ ctx[2];
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			head = element("head");
    			head.innerHTML = `<link href="https://fonts.googleapis.com/css?family=Lato" rel="stylesheet">`;
    			t0 = space();
    			h1 = element("h1");
    			h1.textContent = "Test";
    			t2 = space();
    			...
    			t4 = space();
    			h3 = element("h3");
    			h3.textContent = "picture source";
    			t6 = space();
    			audio_1 = element("audio");
    			audio_1.innerHTML = `<source src="ballon.mp3">`;
